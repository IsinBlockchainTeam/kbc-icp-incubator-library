...
import {FundStatusEnum, Phase, PhaseEnum, Shipment, RoleProof, EvaluationStatus, EvaluationStatusEnum, DocumentInfo, DocumentType, DocumentTypeEnum} from '../models/types';
