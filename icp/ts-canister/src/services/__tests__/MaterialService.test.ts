...
describe("MaterialService", () => {
    ...
    it("retrieves a material by id", () => {
        ...
        expect(() => materialService.getMaterial(1n)).toThrow(
            new Error("(MATERIAL_NOT_FOUND) Material not found."),
        );
    });
    ...
    it("creates a material", () => {
        ...
        expect(() => materialService.createMaterial(0n)).toThrow(
            new Error(
    ...
    it("updates a material", () => {
        ...
        mockedFn.get.mockReturnValue(expectedResponse);
        expect(materialService.updateMaterial(0n, 0n)).toEqual(
            expectedResponse,
        );
        expect(mockedFn.get).toHaveBeenCalled();
        expect(mockedFn.insert).toHaveBeenCalled();
