...
describe("ProductCategoryService", () => {
    ...
    it("retrieves all product categories", () => {
        ...
        expect(productCategoryService.getProductCategories()).toEqual(
            expectedResponse,
        );
    ...
    it("retrieves a product category by id", () => {
        ...
        expect(productCategoryService.getProductCategory(1n)).toEqual(
            expectedResponse,
        );
        expect(mockedFn.get).toHaveBeenCalled();

        mockedFn.get.mockReturnValue(undefined);
        expect(() => productCategoryService.getProductCategory(1n)).toThrow(
            new Error(
    ...
    it("creates a product category", () => {
        ...
        expect(
            productCategoryService.createProductCategory("test", 1n, "test"),
