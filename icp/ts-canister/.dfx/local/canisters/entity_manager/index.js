...
import { idlFactory } from './entity_manager.did.js';
export { idlFactory } from './entity_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ENTITY_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./entity_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the entity_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./entity_manager.did.js")._SERVICE>}
 */
export const entity_manager = createActor(canisterId);
