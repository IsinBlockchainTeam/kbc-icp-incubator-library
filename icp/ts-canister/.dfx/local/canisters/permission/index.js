...
import { idlFactory } from './permission.did.js';
export { idlFactory } from './permission.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PERMISSION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./permission.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the permission canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./permission.did.js")._SERVICE>}
 */
export const permission = createActor(canisterId);
