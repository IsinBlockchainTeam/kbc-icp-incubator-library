...
describe('GraphService lifecycle', () => {
    ...
    // const _registerProductCategories = async (
    //     productCategories: ProductCategory[]
    // ): Promise<ProductCategory[]> => {
    //     const result: ProductCategory[] = [];
    //     await serial(
    //         productCategories.map((category) => async () => {
    //             result.push(
    ...
    // };
    //
    // const _registerAssetOperations = async (
    //     assetOperations: AssetOperation[]
    // ): Promise<AssetOperation[]> => {
    //     const result: AssetOperation[] = [];
    //     await serial(
    //         assetOperations.map((assetOperation) => async () => {
    //             result.push(
    //                 await assetOperationService.registerAssetOperation(
    //                     assetOperation.name,
    //                     assetOperation.inputMaterials.map((m) => m.id),
    //                     assetOperation.outputMaterial.id,
    ...
    //         trade = await tradeManagerService.registerBasicTrade(
    //             trade.supplier,
    //             customer,
    //             trade.commissioner,
    //             (trade as BasicTrade).name
    //         );
    ...
    //         });
    //     } else {
    //         trade = await tradeManagerService.registerOrderTrade(
    //             trade.supplier,
    //             customer,
    //             trade.commissioner,
    //             paymentDeadline,
    ...
    //                           (line as OrderLine).quantity,
    //                           (line as OrderLine).price
    //                       );
    ...
    //             if (tradeType === TradeType.ORDER) (trade as OrderTrade).hasSupplierSigned = true;
    //         })
    //     );
    //     return trade;
    // };
    ...
    //                 'Small coffee bag',
    //                 90,
    //                 'Final coffee packed in a small bag'
    //             ),
    //             new ProductCategory(
    //                 0,
    //                 'Medium coffee bag',
    //                 90,
    //                 'Final coffee packed in a medium bag'
    //             ),
    //             new ProductCategory(
    //                 0,
    //                 'Batch of coffee bags',
    //                 90,
    //                 'Batch of a small and a medium coffee bag'
    //             ),
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: coffee beans processing',
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: coffee grinding',
    //                 [materials[2]],
    //                 materials[3],
    //                 '-74.9828170',
    //                 '-28.6505430'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: water gathering',
    //                 [materials[10]],
    //                 materials[4],
    //                 '-73.4667',
    //                 '-23.5505'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'CONSOLIDATION: sea water transfer',
    //                 [materials[4]],
    //                 materials[4],
    //                 '-73.9265',
    //                 '-23.4733'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'CONSOLIDATION: another sea water transfer',
    //                 [materials[4]],
    //                 materials[4],
    //                 '-73.3468',
    //                 '-23.5505'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: water purification',
    //                 [materials[4]],
    //                 materials[5],
    //                 '-72.65497',
    //                 '-23.5505'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: final coffee production',
    //                 [materials[3], materials[5]],
    //                 materials[6],
    //                 '34.6836',
    //                 '135.52'
    //             ),
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: small coffee packaging',
    //                 [materials[6]],
    //                 materials[7],
    //                 '-73.64826',
    //                 '-23.5505'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: medium coffee packaging',
    //                 [materials[6]],
    //                 materials[8],
    //                 '-34.7567',
    //                 '135.52'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: coffee bags packaging',
    //                 [materials[7], materials[8]],
    //                 materials[9],
    //                 '-73.1643',
    //                 '-23.5505'
    //             )
    ...
    //                 externalUrl,
    //                 [],
    //                 'shipping sea water again again'
    //             ),
    //             new BasicTrade(
    //                 0,
    //                 company1.address,
    ...
    //
    //         expect(result.nodes).toEqual(expect.arrayContaining([assetOperations[0]]));
    //
    //         expect(result.edges).toEqual([]);
    //     }, 30000);
    //
    ...
    //                 85,
    //                 'Roasted beans of Arabica coffee'
    //             )
    //         ]);
    //
    //         materials = await _registerMaterials([
    ...
    //             new AssetOperation(
    //                 0,
    //                 'CONSOLIDATION: arabica beans transfer',
    //                 [materials[0]],
    //                 materials[0],
    //                 '-73.9828170',
    //                 '-28.6505430'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'TRANSFORMATION: arabica beans roasting',
    //                 [materials[0]],
    //                 materials[1],
    //                 '-73.9828170',
    //                 '-28.6505430'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'CONSOLIDATION: roasted arabica beans transfer',
    //                 [materials[1]],
    //                 materials[1],
    //                 '-72.982870',
    //                 '-26.6505430'
    ...
    //             new AssetOperation(
    //                 0,
    //                 'CONSOLIDATION: another roasted arabica beans transfer',
    //                 [materials[1]],
    //                 materials[1],
    //                 '-74.9828170',
    //                 '-28.7148'
    ...
    //                 externalUrl,
    //                 [],
    //                 'Roasted arabica beans purchase'
    //             ),
    //             new BasicTrade(
    //                 0,
    //                 company3.address,
    ...
    //                 externalUrl,
    //                 [],
    //                 'Another roasted arabica beans purchase'
    //             )
    //         ];
    //         const newTradeLines = [
    ...
    //             trades.push(
    //                 await _registerTrade(newTrades[i], [newTradeLines[i]], TradeType.BASIC)
    //             );
    //         }
    //     }, 30000);
    //
