...
//             tradeDriver: new OrderTradeDriver(signer, orderAddress, MATERIAL_MANAGER_CONTRACT_ADDRESS, PRODUCT_CATEGORY_CONTRACT_ADDRESS),
//         });
//     };
//
...
//     }> => {
//         const tradeId: OrderTradeInfo = await tradeManagerService.registerOrderTrade(SUPPLIER_ADDRESS, CUSTOMER_ADDRESS, OTHER_ADDRESS, deadline, deadline, arbiter, deadline, deadline, 1000, MY_TOKEN_CONTRACT_ADDRESS);
//         const trade: OrderTradeInfo = await tradeManagerService.getTrade(tradeId);
