...
import {OrderLinePrice, OrderLineRequest, OrderTrade} from '../entities/OrderTrade';
...
describe('Document lifecycle', () => {
    ...
    const createOrderAndConfirm = async (): Promise<{orderId: number, orderTradeService: OrderTradeService}> => {
        ...
        const orderTradeService = new OrderTradeService(new OrderTradeDriver(signer, await tradeManagerService.getTrade(order.tradeId), MATERIAL_MANAGER_CONTRACT_ADDRESS, PRODUCT_CATEGORY_CONTRACT_ADDRESS));
