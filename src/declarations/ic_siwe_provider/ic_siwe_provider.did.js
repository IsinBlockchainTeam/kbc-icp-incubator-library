...
const idlFactory = ({
  ...
  return IDL.Service({
    ...
    'siwe_get_delegation': IDL.Func([Address, SessionKey, Timestamp], [GetDelegationResponse], ['query']),
    'siwe_login': IDL.Func([SiweSignature, Address, SessionKey], [LoginResponse], []),
