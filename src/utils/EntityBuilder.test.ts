describe('EntityBuilder', () => {
    ...
    //         bcTrade.owner = 'owner';
    //
    //         expect(EntityBuilder.buildBasicTrade(bcTrade)).toEqual(new Trade(0, 'trade', [[1, 2]], 'owner'));
    //     });
    // });
    //
    ...
    //             new OrderInfo(bcOrder.id.toNumber(), bcOrder.supplier, bcOrder.customer, bcOrder.externalUrl, bcOrder.offeree, bcOrder.offeror, bcOrder.lineIds.map((l) => l.toNumber()),
