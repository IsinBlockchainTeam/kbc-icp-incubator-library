...
describe('GraphService', () => {
    ...
    const assetOperations: AssetOperation[] = [
        ...
        new AssetOperation(
            4,
            'Final coffee production',
            [materials[3], materials[5]],
            materials[6],
            '-73.64826',
            '-23.5505',
            [processTypes[0], processTypes[1]]
        ),
        new AssetOperation(
            5,
            'Final coffee consolidation',
            [materials[6]],
            materials[6],
            '-34.7567',
            '135.52',
    ...
    const trades: Trade[] = [
        new BasicTrade(
            ...
            'company2',
            'externalUrl',
            [new Line(1, materials[2], productCategories[2], 100, units[0])],
        ...
        new BasicTrade(
            ...
            'company3',
            'externalUrl',
            [new Line(1, materials[5], productCategories[5], 150, units[1])],
        ...
        new BasicTrade(
            ...
            'company1',
            'externalUrl',
            [new Line(1, materials[6], productCategories[6], 200, units[0])],
            'shipping final coffee'
        )
    ];
    ...
    beforeAll(() => {
        graphService = new GraphService(
            createMock<Signer>(),
            mockedTradeManagerService,
            mockedAssetOperationService
        );
    });
