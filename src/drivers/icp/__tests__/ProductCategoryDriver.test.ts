...
describe('ProductCategoryDriver', () => {
    ...
    it('should retrieve product categories', async () => {
        ...
        await expect(productCategoryDriver.getProductCategories()).resolves.toEqual([defaultProductCategory]);
    ...
    it('should retrieve a product category', async () => {
        ...
        await expect(productCategoryDriver.getProductCategory(1)).resolves.toEqual(defaultProductCategory);
    ...
    it('should create a product category', async () => {
        ...
        await expect(productCategoryDriver.createProductCategory('test', 1, 'test')).resolves.toEqual(defaultProductCategory);
    ...
    it('should update a product category', async () => {
        ...
        await expect(productCategoryDriver.updateProductCategory(1, 'test', 1, 'test')).resolves.toEqual(defaultProductCategory);
