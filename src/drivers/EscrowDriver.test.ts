...
describe('EscrowDriver', () => {
    ...
    it('should correctly retrieve state - LOCKED', async () => {
        ...
        expect(response).toEqual(EscrowStatus.LOCKED);
    ...
    it('should correctly retrieve state - CLOSED', async () => {
        ...
        expect(response).toEqual(EscrowStatus.CLOSED);
    ...
    it('should correctly lock', async () => {
        ...
        expect(mockedContract.lock).toHaveBeenCalledTimes(1);
        expect(mockedContract.lock).toHaveBeenNthCalledWith(1);
        expect(mockedWait).toHaveBeenCalledTimes(1);
    });
