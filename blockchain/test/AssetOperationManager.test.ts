...
describe('AssetOperationManager', () => {
    ...
    describe('Register', () => {
        ...
        it('should register an AssetOperation - FAIL(AssetOperationManager: Output material does not exist)', async () => {
            await expect(
                assertOperationManagerContract.registerAssetOperation('testTransformation', [[1], [2]], 15, '38.8951', '-77.0364', processTypes)
        ...
        it('should register an AssetOperation - FAIL(AssetOperationManager: Input material does not exist)', async () => {
            await expect(
                assertOperationManagerContract.registerAssetOperation('testTransformation', [[1], [15]], 3, '38.8951', '-77.0364', processTypes)
        ...
        it('should register an AssetOperation - FAIL(AssetOperationManager: At least one process type must be specified)', async () => {
            await expect(
                assertOperationManagerContract.registerAssetOperation('testTransformation', [[1], [2]], 3, '38.8951', '-77.0364', [])
        ...
        it('should get AssetOperation type - FAIL(AssetOperationManager: Asset operation does not exist)', async () => {
            await expect(assertOperationManagerContract.getAssetOperationType(1)).to.be.revertedWith(
