...
describe('ProductCategoryManager', () => {
    ...
    describe('Registration', () => {
        it('should register two ProductCategories', async () => {
            ...
            const tx = await productCategoryManagerContract.registerProductCategory('testProductCategory', 85);
            await tx.wait();
            ...
            expect(registeredProductCategory[3]).to.be.equal(true);
            ...
            const tx2 = await productCategoryManagerContract.registerProductCategory('testProductCategory2', 90);
            await tx2.wait();
    ...
    describe('Roles', () => {
        it('should add and remove admin roles', async () => {
            ...
            expect(await productCategoryManagerContract.hasRole(await productCategoryManagerContract.ADMIN_ROLE(), other.address)).to.be.true;
            await productCategoryManagerContract.connect(admin).removeAdmin(other.address);
            expect(await productCategoryManagerContract.hasRole(await productCategoryManagerContract.ADMIN_ROLE(), other.address)).to.be.false;
        });
