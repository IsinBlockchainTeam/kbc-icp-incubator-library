...
describe('OfferManager', () => {
    ...
    describe('registerSupplier', () => {
        ...
        it("should register a supplier - FAIL(Offer's supplier already registered)", async () => {
            ...
            await expect(offerManagerContract.registerSupplier(company1.address, 'Company 2')).to.be.revertedWith(
    ...
    describe('registerOffer', () => {
        ...
        it('should register an Offer - FAIL(OfferManager: Product category does not exist)', async () => {
            ...
            await expect(offerManagerContract.registerOffer(company1.address, 20)).to.be.revertedWith(
                'OfferManager: Product category does not exist'
            );
        });

        it("should register an Offer - FAIL(Offer's supplier not registered)", async () => {
            await expect(offerManagerContract.registerOffer(company1.address, 1)).to.be.revertedWith("OfferManager: Offer's supplier not registered");
        });
    });
    ...
    describe('updateSupplier', () => {
        ...
        it("should update a supplier - FAIL(Offer's supplier not registered)", async () => {
            await expect(offerManagerContract.updateSupplier(company1.address, 'Company 2')).to.be.revertedWith("Offer's supplier not registered");
        });
    });
    ...
    describe('updateOffer', () => {
        ...
        it('should emit OfferUpdated event', async () => {
            await (await offerManagerContract.registerSupplier(company1.address, 'Company 1')).wait();
            await (await offerManagerContract.registerOffer(company1.address, 1)).wait();
            await expect(offerManagerContract.updateOffer(1, 2)).to.emit(offerManagerContract, 'OfferUpdated').withArgs(1, company1.address);
        });

        it('should update a AssetOperation - FAIL(OfferManager: Product category does not exist)', async () => {
            await expect(offerManagerContract.updateOffer(1, 20)).to.be.revertedWith('OfferManager: Product category does not exist');
        });
    });
    ...
    describe('deleteSupplier', () => {
        ...
        it("should delete a supplier - FAIL(Offer's supplier not registered)", async () => {
            await expect(offerManagerContract.deleteSupplier(company1.address)).to.be.revertedWith("Offer's supplier not registered");
        });
    ...
    describe('deleteOffer', () => {
        ...
        it('should emit OfferDeleted event', async () => {
            await (await offerManagerContract.registerSupplier(company1.address, 'Company 1')).wait();
            await (await offerManagerContract.registerOffer(company1.address, 1)).wait();
            await expect(offerManagerContract.deleteOffer(1)).to.emit(offerManagerContract, 'OfferDeleted').withArgs(1, company1.address);
        });

        it('should update a Transformation - FAIL(Offer does not exist)', async () => {
            await expect(offerManagerContract.updateOffer(1, 1)).to.be.revertedWith('Offer does not exist');
        });
    });
