...
describe('SupplyChainManager', () => {
    ...
    describe('Update', async () => {
        [
            ...
            { resource: 'Transformation', registerArgs: ['testTransformation', [1, 2], 3], updateArgs: [0, 'testTransformationNew', [4, 5], 6], expectedResource: { id: BigNumber.from(0), name: 'testTransformationNew', inputMaterialsIds: [BigNumber.from(4), BigNumber.from(5)], outputMaterialId: BigNumber.from(6) } },
        ]
            .forEach(({ resource, registerArgs, updateArgs, expectedResource }) => {
